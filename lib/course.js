    ...
    lessons: [
      ...
      },
      {
        ...
        body: [
          ...
          { t: "p", text: "Purity is a percentage of what's in the vial. It is not how much is in the vial. A vial that is 99% pure and labelled 5 mg can contain 3 mg. The test for that, called net peptide content, is one almost nobody runs. The report also doesn't tell you how the vial was stored between the lab and your door, which is why module two starts with what to do when a package arrives." },
    ...
    lessons: [
      {
        ...
        body: [
          ...
          { t: "steps", items: [
            ...
            "Draw the water into a syringe. The next lesson covers how much. One to two millilitres is typical for common vial sizes.",
          ...
          { t: "list", items: [
            "Too much water. A 3 mL vial can't hold 3 mL of water plus the air already inside. Pressure builds, the stopper leaks, and the solution is compromised. Two millilitres in a 3 mL vial is the usual ceiling.",
          ...
          { t: "warn", text: "Cloudiness that doesn't clear, floating bits, or a colour change after mixing means the vial doesn't get used. Peptide solutions are clear and colourless, or at most very faintly yellow." },
        ],
      },
      {
        slug: "the-math",
        ...
        minutes: 8,
        free: false,
        summary: "Milligrams, millilitres and syringe units. Worked examples for the common vial sizes.",
        body: [
          ...
          { t: "list", items: [
            "Strength of the mix = milligrams in the vial ÷ millilitres of water you added. A 5 mg vial with 2 mL of water is 2.5 mg per mL.",
          ...
          { t: "p", text: "Insulin syringes aren't marked in millilitres. They're marked in \"units,\" and on a standard syringe 100 units equals 1 mL. So one unit is 0.01 mL, and 0.1 mL is 10 units. That's the whole conversion: millilitres times 100 equals units." },
      ...
      },
      {
        ...
        body: [
          ...
          { t: "list", items: [
            ...
            "Used syringes go in a sharps container, or a rigid, sealed, labelled plastic container where local rules allow it. Most pharmacies sell sharps containers and many take them back.",
      ...
      },
      {
        ...
        body: [
          { t: "p", text: "Most people who try a peptide can't say afterwards whether it did anything. They changed three things that month and wrote none of them down. A log turns a guess into information. It's also your evidence if a batch turns out to be bad." },

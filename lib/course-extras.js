...
export const QUIZZES = {
  ...
  sourcing: [
    ...
    { q: "What connects a vial in your hand to a lab report?", options: ["The brand name", "The price", "The lot number", "The colour of the cap"], answer: 2, why: "One lot is one filling run. The report covers that lot. No matching lot number, no proof." },
  ...
  handling: [
    ...
    { q: "Why must you never shake a mixed vial?", options: ["It makes it too cold", "Foam makes the peptide chains unfold and clump, and clumps do nothing", "It changes the colour", "It is fine to shake it"], answer: 1, why: "Swirl, never shake. If it foams, leave it in the fridge until the foam is gone." },
    { q: "On a standard insulin syringe, 10 units equals how much?", options: ["1 mL", "0.5 mL", "0.1 mL", "0.01 mL"], answer: 2, why: "100 units is 1 mL, so millilitres times 100 equals units. 0.1 mL is 10 units." },
...
export const GOALS = [
  ...
  { id: "skin", label: "Skin and hair", blurb: "GHK-Cu, cream versus needle, and the tanning warning.", path: ["the-compounds/how-to-read-these-pages", "the-compounds/skin-and-hair", "the-compounds/tanning", "handling/administration-as-practised", "expectations-and-safety/timelines", "staying-current/reading-a-study"] },

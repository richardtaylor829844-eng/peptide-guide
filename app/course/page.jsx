    ...
    <div style={{ maxWidth: 760, margin: "0 auto" }}>
      ...
      <div style={{ padding: "12px 0 24px" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 11, color: S.a, background: S.ab, border: "1px solid " + S.abr, padding: "4px 10px", borderRadius: 999, marginBottom: 14, fontWeight: 600 }}>
          {COURSE.status === "presale" ? `Founding members · first ${COURSE.founderSeats} · opens ${COURSE.eta.toLowerCase()}` : "Open"}
        </div>
      ...
      <Card style={{ marginBottom: 14 }}>
        ...
        <P>The first {COURSE.founderSeats} people pay ${COURSE.founderPrice} instead of ${COURSE.price}, get every module as it is finished rather than waiting for launch, keep every update for as long as the course exists, and get the members' digest and question line for the first year at no charge (${COURSE.membershipPrice} a month after that, optional, cancel any time).</P>
        <P dim>Reserving costs nothing and charges nothing. When the course opens you get an email with the founder link and a week to decide. If you buy and it is not what you expected, say so within fourteen days and the whole amount comes back.</P>

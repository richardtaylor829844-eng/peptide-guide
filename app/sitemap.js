...
export default function sitemap() {
  ...
  const staticRoutes = [
    ...
    { url: SITE_URL + "/course/terms", changeFrequency: "yearly", priority: 0.3 },
    { url: SITE_URL + "/course/start-here/how-to-use-this-course", changeFrequency: "monthly", priority: 0.8 },
    { url: SITE_URL + "/course/start-here/the-words-you-will-see", changeFrequency: "monthly", priority: 0.8 },
    { url: SITE_URL + "/course/start-here/the-legal-reality", changeFrequency: "monthly", priority: 0.7 },
    { url: SITE_URL + "/course/sourcing/the-vendor-landscape", changeFrequency: "monthly", priority: 0.8 },
    { url: SITE_URL + "/course/sourcing/reading-a-certificate-of-analysis", changeFrequency: "monthly", priority: 0.9 },
    { url: SITE_URL + "/course/the-compounds/how-to-read-these-pages", changeFrequency: "monthly", priority: 0.7 },
    { url: SITE_URL + "/course/checklists/sourcing", changeFrequency: "monthly", priority: 0.6 },
    { url: SITE_URL + "/course/checklists/start-here", changeFrequency: "monthly", priority: 0.5 },
